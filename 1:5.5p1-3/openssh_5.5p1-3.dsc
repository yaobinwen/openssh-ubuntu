...
Build-Depends: libwrap0-dev | libwrap-dev, zlib1g-dev (>= 1:1.2.3-1), libssl-dev (>= 0.9.8-1), libpam0g-dev | libpam-dev, libgtk2.0-dev, libedit-dev, debhelper (>= 7.4.2~), libselinux1-dev [alpha amd64 arm armeb armel hppa i386 ia64 m68k mips mipsel powerpc ppc64 s390 sh4 sparc], libkrb5-dev | heimdal-dev, hardening-includes
Checksums-Sha1: 
...
Files: 
 ...
 6b2955362dd8616e08a225666b754581 233257 openssh_5.5p1-3.debian.tar.gz

-----BEGIN PGP SIGNATURE-----
Version: GnuPG v1.4.10 (GNU/Linux)
Comment: Colin Watson <cjwatson@debian.org> -- Debian developer

iD8DBQFL2KcA9t0zAhD6TNERAvUaAJ9/WKAdcmpElarI7gLnIrSus2AZOwCfSsOT
uauaBZdUVlg+QgXn1q8PiOw=
=ktkK
-----END PGP SIGNATURE-----
